...
func (r ApiGetQuotePostRequest) Execute() (*GetQuoteResponse, *http.Response, error) {
...
func (a *QuotesAPIService) GetQuotePostExecute(r ApiGetQuotePostRequest) (*GetQuoteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetQuoteResponse
	)
