...
func (r ApiCancelPickupPostRequest) Execute() (*GenericResponse, *http.Response, error) {
...
func (a *ShipmentsAPIService) CancelPickupPostExecute(r ApiCancelPickupPostRequest) (*GenericResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
