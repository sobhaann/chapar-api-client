...
func (r ApiBulkImportPostRequest) Input(input BulkImportRequestInput) ApiBulkImportPostRequest {
	r.input = &input
	return r
}
...
func (r ApiBulkImportPostRequest) Execute() (*SuccessResponse, *http.Response, error) {
...
func (a *ShipmentsAPIService) BulkImportPostExecute(r ApiBulkImportPostRequest) (*SuccessResponse, *http.Response, error) {
	var (
...
func (r ApiCancelPickupPostRequest) Input(input CancelPickupRequestInput) ApiCancelPickupPostRequest {
	r.input = &input
	return r
}

func (r ApiCancelPickupPostRequest) Execute() (*SuccessResponse, *http.Response, error) {
...
// Execute executes the request
//  @return SuccessResponse
func (a *ShipmentsAPIService) CancelPickupPostExecute(r ApiCancelPickupPostRequest) (*SuccessResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
