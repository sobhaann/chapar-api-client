...
type TrackingResponse struct {
	...
	Objects TrackingObjects `json:"objects"`
}

type _TrackingResponse TrackingResponse
...
func (o *TrackingResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *TrackingResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTrackingResponse := _TrackingResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTrackingResponse)

	if err != nil {
		return err
	}

	*o = TrackingResponse(varTrackingResponse)
