...
type GetCityResponse struct {
	Objects *GetCityResponseObjects `json:"objects,omitempty"`
}
...
func (o *GetCityResponse) GetObjects() GetCityResponseObjects {
	if o == nil || IsNil(o.Objects) {
		var ret GetCityResponseObjects
		return ret
	}
	return *o.Objects
}
...
// SetObjects gets a reference to the given GetCityResponseObjects and assigns it to the Objects field.
