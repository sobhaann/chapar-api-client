...
type TrackingHistoryItem struct {
	Attach NullableString `json:"attach,omitempty"`
...
// SetAttach gets a reference to the given NullableString and assigns it to the Attach field.
func (o *TrackingHistoryItem) SetAttach(v string) {
	o.Attach.Set(&v)
}
// SetAttachNil sets the value for Attach to be an explicit nil
func (o *TrackingHistoryItem) SetAttachNil() {
	o.Attach.Set(nil)
}
...
func (o TrackingHistoryItem) ToMap() (map[string]interface{}, error) {
	...
	if o.Attach.IsSet() {
		toSerialize["attach"] = o.Attach.Get()
	}
